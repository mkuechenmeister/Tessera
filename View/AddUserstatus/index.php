<?php
    ...
    $pageTitle = "Benutzerstatus hinzufügen";
        ...
        <div class="row">
            <div class="col-lg-10 col-xl-9 mx-auto">
                <div class="card card-signin flex-row my-5">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">Neuen Benutzerstatus hinzufügen</h5>
                        <form class="form-signin" action="nda/doAddUserstatus.php" method="post">

                            <div class="form-label-group">
                                <input type="text" id="name" name="name" class="form-control" placeholder="Benutzerstatus" >
                                <label for="name">Benutzerstatus</label>
                            </div>
