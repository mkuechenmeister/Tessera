...
<?php
    ...
    $pageTitle = "Registrierungsformular@Tessera";
        ...
        <div class="row">
            <div class="col-lg-10 col-xl-9 mx-auto">
                <div class="card card-signin flex-row my-5">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">Neuen Benutzer anlegen</h5>
                        <form class="form-signin" action="nda/doSignup.php" method="post">

                            <div class="form-label-group">
                                <input type="text" id="inputUserame" name="username" class="form-control" placeholder="Benutzername" required autofocus>
                                <label for="inputUserame">Benutzername</label>
                            </div>
                            ...
                            <div class="form-label-group">
                                <select name="department" id="department" class="form-control" required>
                                    <option value="Abteilung" disabled selected >Abteilung</option> //head of Select
