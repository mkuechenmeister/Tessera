<?php
    ...
    $customCss = "../../css/addEntities.css";    require_once("../01GeneralHelper/header.php");
        ...
        <div class="row">
            <div class="col-lg-10 col-xl-9 mx-auto">
                <div class="card card-signin flex-row my-5">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">Neue Abteilung hinzufügen</h5>
                        <form class="form-signin" action="nda/doAddDepartment.php" method="post">

                            <div class="form-label-group">
                                <input type="text" id="name" name="name" class="form-control" placeholder="Abteilungsname" >
