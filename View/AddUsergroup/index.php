        ...
        <div class="row">
            <div class="col-lg-10 col-xl-9 mx-auto">
                <div class="card card-signin flex-row my-5">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">Neue Benutzergruppe hinzufügen</h5>
                        <form class="form-signin" action="nda/doAddUsergroup.php" method="post">

                            <div class="form-label-group">
                                <input type="text" id="name" name="name" class="form-control" placeholder="Gruppenname" >
